...
class TestMFCC(TestCase):
    ...
    def testRealCase(self):
        ...
        expected = [ -9.20314026e+02, 5.88640251e+01, -4.10506325e+01, 2.33455582e+01,
                    -1.43520842e+01, 8.78111553e+00, -5.37748861e+00, 3.02693152e+00,
                    -1.77745247e+00, 1.12793589e+00, -5.64456940e-01, 2.59754241e-01,
                    5.14549851e-01]

        # reference value before commit 064d539
